...
<div class="card">
  ...
  <div class="text-right">
    <div class="actions">
      <a type="button" href = "/Subject/lesson/create/{{$subject_id}}" class="btn btn-primary btn-icon-label  rounded-0" style = "background-color:#13ba91; border:0px;" >
...
for (const key in list) {
  ...
  lessons_list.push({
        ...
        duration: 120 ,
        sources: [
        { src: `{{asset('/Lessons/SubjectLessons/${list[key]._360p}')}}` , type:'video/mp4' ,label:'360P' , selected:'true'},
        { src: `{{asset('/Lessons/SubjectLessons/${list[key]._480p}')}}`, type: 'video/mp4' ,label:'480P' },
        { src: `{{asset('/Lessons/SubjectLessons/${list[key]._720p}')}}`, type: 'video/mp4' , label:'720P' },
         ], 
        thumbnail: [{
