...
<div class="container my-3">
  ...
  <div class="card-header">{{__('LivestreamCreate.formTitle')}}</div>
    <div class="card-body">
      <form class="" action="/LiveCourse/store" method="post"  enctype="multipart/form-data">
        @csrf
        
        <div class="form-row">
          <div class="col-md-12 mb-3">
            <label for="2011">{{__('LivestreamCreate.title')}}</label>
            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror " id="2011" placeholder="{{__('LivestreamCreate.titlePlaceholder')}}"  value="{{ old('title') }}"  required>
        ...
        <div class="form-row">
          <div class="col-md-12 mb-3">
            ...
            <textarea name="description" 
                      ...
                      id="3011" 
                      placeholder="{{__('LivestreamCreate.descriptionPlaceholder')}}" >{{ old('description') }}</textarea>
