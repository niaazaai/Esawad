...
<div class="container mt-5">
  <div class="row justify-content-md-center  ">
    ...
    <div class="card">
    <div class="card-body">
        <h5>{{__('CourseCreate.lessFromTitle')}}</h5>
     <hr>
      ...
      <div class="card-footer">
        ...
        <a href="/Course/show/{{$course_id}}" class="btn btn-primary mr-2"  >برگشت</a>
      </div>
...
<!-- 
      <form action="/Course/lesson/store" method="post" enctype="multipart/form-data" >
    </form>
 -->
