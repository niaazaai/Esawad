 ...
 <header class="" dir = "ltr">
    ...
    <ul class="navbar-nav mr-auto" style = "font-size:36px;">
        ...
        <li class="nav-item"><a class="nav-link" href="{{route('course.create')}}"   style = "font-size:17px;">ایجاد  کورس</a></li>
        <li class="nav-item"><a class="nav-link" href="{{route('classmodule.create')}}"  style = "font-size:17px;">ایجاد صنف</a></li>
    ...
    @csrf
    <button type="submit" class = "btn btn-sm btn-success btn-icon d-none d-lg-inline-flex " name="button"> <span class="btn-inner--icon mr-1"><i class="fas fa-logout"></i></span>خروج</button>
    </form>
